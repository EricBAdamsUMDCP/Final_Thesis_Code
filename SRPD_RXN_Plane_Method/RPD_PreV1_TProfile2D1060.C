...
void RPD_PreV1_TProfile2D1060(int runnumber, int EtaBins ,int PtBins, int numSystematics, int numVertex, int numEff){
	...
	for (Int_t i=0;i<nCent;i++){		
		...
		//V1Even->cd();
		V1_Even_Histo[i] = new TH1D(Form("RPD_V1_Even_%s", centralitystring[i].c_str()),Form("RPD_V1_Even_10-60%;  Pt; V1 Magnitude [A.U.]", centralitystring[i].c_str()), PtBins, Ptmin, Ptmax);
	
		//V1Odd->cd();
		V1_Odd_Histo[i] = new TH1D(Form("RPD_V1_Odd_%s", centralitystring[i].c_str()), Form("RPD_V1_Odd_10-60%; Eta; V1 Magnitude [A.U.]", centralitystring[i].c_str()), EtaBins, etamin, etamax);
	...
	for (int q = 1; q < 10; q++){
		...
		D->SaveAs(Form("/data2/users/ebadams/Eric_RPD_RXN_Data_Sets/%d/PNG/%s/%s/%d_TP_Neg_NumTrk_wo_RXN_vs_Cent_1060.png", runnumber, Systematics.c_str(), Vertex.c_str(), runnumber));
		TP_Pos_NumTrk_wo_RXN_vs_Cent->Draw("HIST E");
		D->SaveAs(Form("/data2/users/ebadams/Eric_RPD_RXN_Data_Sets/%d/PNG/%s/%s/%d_TP_Pos_NumTrk_wo_RXN_vs_Cent_1060.png", runnumber, Systematics.c_str(), Vertex.c_str(), runnumber));

		TP_Pos_NumTrk_wo_RXN_vs_NTrack->Draw("HIST E");
		D->SaveAs(Form("/data2/users/ebadams/Eric_RPD_RXN_Data_Sets/%d/PNG/%s/%s/%d_TP_Pos_NumTrk_wo_RXN_vs_NTrack_1060.png", runnumber, Systematics.c_str(), Vertex.c_str(), runnumber));
		TP_Neg_NumTrk_wo_RXN_vs_NTrack->Draw("HIST E");
		D->SaveAs(Form("/data2/users/ebadams/Eric_RPD_RXN_Data_Sets/%d/PNG/%s/%s/%d_TP_Neg_NumTrk_wo_RXN_vs_NTrack_1060.png", runnumber, Systematics.c_str(), Vertex.c_str(), runnumber));

		TP_Cent_vs_NTrack->Draw("HIST E");
		D->SaveAs(Form("/data2/users/ebadams/Eric_RPD_RXN_Data_Sets/%d/PNG/%s/%s/%d_TP_Cent_vs_NTrack_1060.png", runnumber, Systematics.c_str(), Vertex.c_str(), runnumber));

		PtvsCentrality->Draw("COLZ");
		D->SaveAs(Form("/data2/users/ebadams/Eric_RPD_RXN_Data_Sets/%d/PNG/%s/%s/%d_PtvsCentrality_1060.png", runnumber, Systematics.c_str(), Vertex.c_str(), runnumber));
		...
		V1_Odd_Histo[q-1]->SaveAs(Form("/data2/users/ebadams/Eric_RPD_RXN_Data_Sets/%d/ROOT/%s/%s/%d_V1_Odd_Histo_10-60_%s.root", runnumber, Systematics.c_str(), Vertex.c_str(), runnumber, centralitystring[q-1].c_str()));
