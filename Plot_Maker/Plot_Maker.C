...
void Plot_Maker( int numSPM_or_RXN, bool Special_Cuts){
		...
		for (int s = 0; s < 4; s++){//systematics
			for(int v = 0; v < 3; v++){//vertex
				...
				//(A) Part A draws in and loads the data files
					...
					Get_HF_Even_326776 = (TProfile*) HF_RXN_Even_326776 ->Get(Form("HF_V1_Even_%s", centralitystring[c].c_str()));
					Get_HF_Even_326822 = (TProfile*) HF_RXN_Even_326822 ->Get(Form("HF_V1_Even_%s", centralitystring[c].c_str()));
					Get_HF_Even_326883 = (TProfile*) HF_RXN_Even_326883 ->Get(Form("HF_V1_Even_%s", centralitystring[c].c_str()));
					Get_HF_Even_326943 = (TProfile*) HF_RXN_Even_326943 ->Get(Form("HF_V1_Even_%s", centralitystring[c].c_str()));
					Get_HF_Even_327078 = (TProfile*) HF_RXN_Even_327078 ->Get(Form("HF_V1_Even_%s", centralitystring[c].c_str()));
					Get_HF_Even_327211 = (TProfile*) HF_RXN_Even_327211 ->Get(Form("HF_V1_Even_%s", centralitystring[c].c_str()));
					Get_HF_Even_327327 = (TProfile*) HF_RXN_Even_327327 ->Get(Form("HF_V1_Even_%s", centralitystring[c].c_str()));
					Get_HF_Even_327464 = (TProfile*) HF_RXN_Even_327464 ->Get(Form("HF_V1_Even_%s", centralitystring[c].c_str()));
					Get_HF_Even_327524 = (TProfile*) HF_RXN_Even_327524 ->Get(Form("HF_V1_Even_%s", centralitystring[c].c_str()));
					Get_HF_Even_327560 = (TProfile*) HF_RXN_Even_327560 ->Get(Form("HF_V1_Even_%s", centralitystring[c].c_str()));
	
					Get_HF__Odd_326776 = (TProfile*) HF_RXN_Odd_326776 ->Get(Form("HF_V1_Odd_%s", centralitystring[c].c_str()));
					Get_HF__Odd_326822 = (TProfile*) HF_RXN_Odd_326822 ->Get(Form("HF_V1_Odd_%s", centralitystring[c].c_str()));
					Get_HF__Odd_326883 = (TProfile*) HF_RXN_Odd_326883 ->Get(Form("HF_V1_Odd_%s", centralitystring[c].c_str()));
					Get_HF__Odd_326943 = (TProfile*) HF_RXN_Odd_326943 ->Get(Form("HF_V1_Odd_%s", centralitystring[c].c_str()));
					Get_HF__Odd_327078 = (TProfile*) HF_RXN_Odd_327078 ->Get(Form("HF_V1_Odd_%s", centralitystring[c].c_str()));
					Get_HF__Odd_327211 = (TProfile*) HF_RXN_Odd_327211 ->Get(Form("HF_V1_Odd_%s", centralitystring[c].c_str()));
					Get_HF__Odd_327327 = (TProfile*) HF_RXN_Odd_327327 ->Get(Form("HF_V1_Odd_%s", centralitystring[c].c_str()));
					Get_HF__Odd_327464 = (TProfile*) HF_RXN_Odd_327464 ->Get(Form("HF_V1_Odd_%s", centralitystring[c].c_str()));
					Get_HF__Odd_327524 = (TProfile*) HF_RXN_Odd_327524 ->Get(Form("HF_V1_Odd_%s", centralitystring[c].c_str()));
					Get_HF__Odd_327560 = (TProfile*) HF_RXN_Odd_327560 ->Get(Form("HF_V1_Odd_%s", centralitystring[c].c_str()));
		
					Get_RPD_Even_326776 = (TProfile*) RPD_RXN_Even_326776 ->Get(Form("RPD_V1_Even_%s", centralitystring[c].c_str()));
					Get_RPD_Even_326822 = (TProfile*) RPD_RXN_Even_326822 ->Get(Form("RPD_V1_Even_%s", centralitystring[c].c_str()));
					Get_RPD_Even_326883 = (TProfile*) RPD_RXN_Even_326883 ->Get(Form("RPD_V1_Even_%s", centralitystring[c].c_str()));
					Get_RPD_Even_326943 = (TProfile*) RPD_RXN_Even_326943 ->Get(Form("RPD_V1_Even_%s", centralitystring[c].c_str()));
					Get_RPD_Even_327078 = (TProfile*) RPD_RXN_Even_327078 ->Get(Form("RPD_V1_Even_%s", centralitystring[c].c_str()));
					Get_RPD_Even_327211 = (TProfile*) RPD_RXN_Even_327211 ->Get(Form("RPD_V1_Even_%s", centralitystring[c].c_str()));
					Get_RPD_Even_327327 = (TProfile*) RPD_RXN_Even_327327 ->Get(Form("RPD_V1_Even_%s", centralitystring[c].c_str()));
					Get_RPD_Even_327464 = (TProfile*) RPD_RXN_Even_327464 ->Get(Form("RPD_V1_Even_%s", centralitystring[c].c_str()));
					Get_RPD_Even_327524 = (TProfile*) RPD_RXN_Even_327524 ->Get(Form("RPD_V1_Even_%s", centralitystring[c].c_str()));
					Get_RPD_Even_327560 = (TProfile*) RPD_RXN_Even_327560 ->Get(Form("RPD_V1_Even_%s", centralitystring[c].c_str()));
		
					Get_RPD_Odd_326776 = (TProfile*) RPD_RXN_Odd_326776 ->Get(Form("RPD_V1_Odd_%s", centralitystring[c].c_str()));
					Get_RPD_Odd_326822 = (TProfile*) RPD_RXN_Odd_326822 ->Get(Form("RPD_V1_Odd_%s", centralitystring[c].c_str()));
					Get_RPD_Odd_326883 = (TProfile*) RPD_RXN_Odd_326883 ->Get(Form("RPD_V1_Odd_%s", centralitystring[c].c_str()));
					Get_RPD_Odd_326943 = (TProfile*) RPD_RXN_Odd_326943 ->Get(Form("RPD_V1_Odd_%s", centralitystring[c].c_str()));
					Get_RPD_Odd_327078 = (TProfile*) RPD_RXN_Odd_327078 ->Get(Form("RPD_V1_Odd_%s", centralitystring[c].c_str()));
					Get_RPD_Odd_327211 = (TProfile*) RPD_RXN_Odd_327211 ->Get(Form("RPD_V1_Odd_%s", centralitystring[c].c_str()));
					Get_RPD_Odd_327327 = (TProfile*) RPD_RXN_Odd_327327 ->Get(Form("RPD_V1_Odd_%s", centralitystring[c].c_str()));
					Get_RPD_Odd_327464 = (TProfile*) RPD_RXN_Odd_327464 ->Get(Form("RPD_V1_Odd_%s", centralitystring[c].c_str()));
					Get_RPD_Odd_327524 = (TProfile*) RPD_RXN_Odd_327524 ->Get(Form("RPD_V1_Odd_%s", centralitystring[c].c_str()));
					Get_RPD_Odd_327560 = (TProfile*) RPD_RXN_Odd_327560 ->Get(Form("RPD_V1_Odd_%s", centralitystring[c].c_str()));
				}
					...
					//(B) Part B get the actual data from the loaded in plots using the "Get" command
					Get_HF_Even_326776  = (TProfile*) HF_SPM_Even_326776 ->Get(Form("HF_V1_Even_%s", centralitystring[c].c_str()));
					Get_HF_Even_326822  = (TProfile*) HF_SPM_Even_326822 ->Get(Form("HF_V1_Even_%s", centralitystring[c].c_str()));
					Get_HF_Even_326883  = (TProfile*) HF_SPM_Even_326883 ->Get(Form("HF_V1_Even_%s", centralitystring[c].c_str()));
					Get_HF_Even_326943  = (TProfile*) HF_SPM_Even_326943 ->Get(Form("HF_V1_Even_%s", centralitystring[c].c_str()));
					Get_HF_Even_327078  = (TProfile*) HF_SPM_Even_327078 ->Get(Form("HF_V1_Even_%s", centralitystring[c].c_str()));
					Get_HF_Even_327211  = (TProfile*) HF_SPM_Even_327211 ->Get(Form("HF_V1_Even_%s", centralitystring[c].c_str()));
					Get_HF_Even_327327  = (TProfile*) HF_SPM_Even_327327 ->Get(Form("HF_V1_Even_%s", centralitystring[c].c_str()));
					Get_HF_Even_327464  = (TProfile*) HF_SPM_Even_327464 ->Get(Form("HF_V1_Even_%s", centralitystring[c].c_str()));
					Get_HF_Even_327524  = (TProfile*) HF_SPM_Even_327524 ->Get(Form("HF_V1_Even_%s", centralitystring[c].c_str()));
					Get_HF_Even_327560  = (TProfile*) HF_SPM_Even_327560 ->Get(Form("HF_V1_Even_%s", centralitystring[c].c_str()));
		 
					Get_HF__Odd_326776  = (TProfile*) HF_SPM_Odd_326776 ->Get(Form("HF_V1_Odd_%s", centralitystring[c].c_str()));
					Get_HF__Odd_326822  = (TProfile*) HF_SPM_Odd_326822 ->Get(Form("HF_V1_Odd_%s", centralitystring[c].c_str()));
					Get_HF__Odd_326883  = (TProfile*) HF_SPM_Odd_326883 ->Get(Form("HF_V1_Odd_%s", centralitystring[c].c_str()));
					Get_HF__Odd_326943  = (TProfile*) HF_SPM_Odd_326943 ->Get(Form("HF_V1_Odd_%s", centralitystring[c].c_str()));
					Get_HF__Odd_327078  = (TProfile*) HF_SPM_Odd_327078 ->Get(Form("HF_V1_Odd_%s", centralitystring[c].c_str()));
					Get_HF__Odd_327211  = (TProfile*) HF_SPM_Odd_327211 ->Get(Form("HF_V1_Odd_%s", centralitystring[c].c_str()));
					Get_HF__Odd_327327  = (TProfile*) HF_SPM_Odd_327327 ->Get(Form("HF_V1_Odd_%s", centralitystring[c].c_str()));
					Get_HF__Odd_327464  = (TProfile*) HF_SPM_Odd_327464 ->Get(Form("HF_V1_Odd_%s", centralitystring[c].c_str()));
					Get_HF__Odd_327524  = (TProfile*) HF_SPM_Odd_327524 ->Get(Form("HF_V1_Odd_%s", centralitystring[c].c_str()));
					Get_HF__Odd_327560  = (TProfile*) HF_SPM_Odd_327560 ->Get(Form("HF_V1_Odd_%s", centralitystring[c].c_str()));
		
					Get_RPD_Even_326776 = (TProfile*) RPD_SPM_Even_326776 ->Get(Form("RPD_V1_Even_%s", centralitystring[c].c_str()));
					Get_RPD_Even_326822 = (TProfile*) RPD_SPM_Even_326822 ->Get(Form("RPD_V1_Even_%s", centralitystring[c].c_str()));
					Get_RPD_Even_326883 = (TProfile*) RPD_SPM_Even_326883 ->Get(Form("RPD_V1_Even_%s", centralitystring[c].c_str()));
					Get_RPD_Even_326943 = (TProfile*) RPD_SPM_Even_326943 ->Get(Form("RPD_V1_Even_%s", centralitystring[c].c_str()));
					Get_RPD_Even_327078 = (TProfile*) RPD_SPM_Even_327078 ->Get(Form("RPD_V1_Even_%s", centralitystring[c].c_str()));
					Get_RPD_Even_327211 = (TProfile*) RPD_SPM_Even_327211 ->Get(Form("RPD_V1_Even_%s", centralitystring[c].c_str()));
					Get_RPD_Even_327327 = (TProfile*) RPD_SPM_Even_327327 ->Get(Form("RPD_V1_Even_%s", centralitystring[c].c_str()));
					Get_RPD_Even_327464 = (TProfile*) RPD_SPM_Even_327464 ->Get(Form("RPD_V1_Even_%s", centralitystring[c].c_str()));
					Get_RPD_Even_327524 = (TProfile*) RPD_SPM_Even_327524 ->Get(Form("RPD_V1_Even_%s", centralitystring[c].c_str()));
					Get_RPD_Even_327560 = (TProfile*) RPD_SPM_Even_327560 ->Get(Form("RPD_V1_Even_%s", centralitystring[c].c_str()));
		
					Get_RPD_Odd_326776 = (TProfile*) RPD_SPM_Odd_326776 ->Get(Form("RPD_V1_Odd_%s", centralitystring[c].c_str()));
					Get_RPD_Odd_326822 = (TProfile*) RPD_SPM_Odd_326822 ->Get(Form("RPD_V1_Odd_%s", centralitystring[c].c_str()));
					Get_RPD_Odd_326883 = (TProfile*) RPD_SPM_Odd_326883 ->Get(Form("RPD_V1_Odd_%s", centralitystring[c].c_str()));
					Get_RPD_Odd_326943 = (TProfile*) RPD_SPM_Odd_326943 ->Get(Form("RPD_V1_Odd_%s", centralitystring[c].c_str()));
					Get_RPD_Odd_327078 = (TProfile*) RPD_SPM_Odd_327078 ->Get(Form("RPD_V1_Odd_%s", centralitystring[c].c_str()));
					Get_RPD_Odd_327211 = (TProfile*) RPD_SPM_Odd_327211 ->Get(Form("RPD_V1_Odd_%s", centralitystring[c].c_str()));
					Get_RPD_Odd_327327 = (TProfile*) RPD_SPM_Odd_327327 ->Get(Form("RPD_V1_Odd_%s", centralitystring[c].c_str()));
					Get_RPD_Odd_327464 = (TProfile*) RPD_SPM_Odd_327464 ->Get(Form("RPD_V1_Odd_%s", centralitystring[c].c_str()));
					Get_RPD_Odd_327524 = (TProfile*) RPD_SPM_Odd_327524 ->Get(Form("RPD_V1_Odd_%s", centralitystring[c].c_str()));
					Get_RPD_Odd_327560 = (TProfile*) RPD_SPM_Odd_327560 ->Get(Form("RPD_V1_Odd_%s", centralitystring[c].c_str()));
				...
				D->SaveAs(Form("/home/ebadams/Final_Thesis_Code/Run_Summed_Data/%s/%s/HF_Odd_Storage_Cent_%s_Sys_%s_Vert_%s.root", Systematics[s].c_str(), Verticies[v].c_str(), centralitystring[c].c_str(), Systematics[s].c_str(), Verticies[v].c_str()));
				RPD_Odd_Storage[c][s][v]->Draw("HIST E");
				D->SaveAs(Form("/home/ebadams/Final_Thesis_Code/Run_Summed_Data/%s/%s/RPD_Odd_Storage_Cent_%s_Sys_%s_Vert_%s.root", Systematics[s].c_str(), Verticies[v].c_str(), centralitystring[c].c_str(), Systematics[s].c_str(), Verticies[v].c_str()));
				HF_Odd_Storage[c][s][v]->Draw("HIST E");
				D->SaveAs(Form("/home/ebadams/Final_Thesis_Code/Run_Summed_Data/%s/%s/HF_Odd_Storage_Cent_%s_Sys_%s_Vert_%s.root", Systematics[s].c_str(), Verticies[v].c_str(), centralitystring[c].c_str(), Systematics[s].c_str(), Verticies[v].c_str()));
				RPD_Odd_Storage[c][s][v]->Draw("HIST E");
				D->SaveAs(Form("/home/ebadams/Final_Thesis_Code/Run_Summed_Data/%s/%s/RPD_Odd_Storage_Cent_%s_Sys_%s_Vert_%s.root", Systematics[s].c_str(), Verticies[v].c_str(), centralitystring[c].c_str(), Systematics[s].c_str(), Verticies[v].c_str()));
				...
				D->SaveAs(Form("/home/ebadams/Final_Thesis_Code/Run_Summed_Data/%s/%s/HF_Even_Storage_Cent_%s_Sys_%s_Vert_%s.root", Systematics[s].c_str(), Verticies[v].c_str(), centralitystring[c].c_str(), Systematics[s].c_str(), Verticies[v].c_str()));
				RPD_Even_Storage[c][s][v]->Draw("HIST E");;
				D->SaveAs(Form("/home/ebadams/Final_Thesis_Code/Run_Summed_Data/%s/%s/RPD_Even_Storage_Cent_%s_Sys_%s_Vert_%s.root", Systematics[s].c_str(), Verticies[v].c_str(), centralitystring[c].c_str(), Systematics[s].c_str(), Verticies[v].c_str()));
				HF_Even_Storage[c][s][v]->Draw("HIST E");;
				D->SaveAs(Form("/home/ebadams/Final_Thesis_Code/Run_Summed_Data/%s/%s/HF_Even_Storage_Cent_%s_Sys_%s_Vert_%s.root", Systematics[s].c_str(), Verticies[v].c_str(), centralitystring[c].c_str(), Systematics[s].c_str(), Verticies[v].c_str()));
				RPD_Even_Storage[c][s][v]->Draw("HIST E");;
				D->SaveAs(Form("/home/ebadams/Final_Thesis_Code/Run_Summed_Data/%s/%s/RPD_Even_Storage_Cent_%s_Sys_%s_Vert_%s.root", Systematics[s].c_str(), Verticies[v].c_str(), centralitystring[c].c_str(), Systematics[s].c_str(), Verticies[v].c_str()));
