...
int Three_Sub_Event_Scalar_Product_Method_V1_Only_540(int EtaBins, int PtBins, int numRPD_or_HF, int numSystematics, int numVertex, int runnumber, int numEff){
...
/*	string binchecker = "Cheese For Everyone";
	...
	for ( int i = 0; i < 10; i++){
		...
		V1Even->cd();
		V1_Even_Histo[i] = new TH1D(Form("%s_V1_Even_%s", RPD_or_HF.c_str(),centralitystring[i].c_str()),Form("%s_V1_Even_%s;  Pt; V1 Magnitude [A.U.]", RPD_or_HF.c_str(), centralitystring[i].c_str()), PtBins, Ptmin, Ptmax);
	
		V1Odd->cd();
		V1_Odd_Histo[i] = new TH1D(Form("%s_V1_Odd_%s", RPD_or_HF.c_str(), centralitystring[i].c_str()), Form("%s_V1_Odd_%s; Eta; V1 Magnitude [A.U.]", RPD_or_HF.c_str(), centralitystring[i].c_str()), EtaBins, etamin, etamax);
	}
...
/*
	...
	*/
	...
	TP2D_Pre_QNEGx->Draw("text");
	D->SaveAs(Form("/data2/users/ebadams/Eric_SP_Data_Sets/%s/%d/PNG/%s/%s/FivetoForty_RunNumber_%d_Sys_%s_Vtx_%s_%s_TP2D_Pre_QNEGx.png", RPD_or_HF.c_str(), RunNumber, Systematics.c_str(), Vertex.c_str(), RunNumber, Systematics.c_str(), Vertex.c_str(), RPD_or_HF.c_str()));
	TP2D_Pre_QNEGx->SaveAs(Form("/data2/users/ebadams/Eric_SP_Data_Sets/%s/%d/ROOT/%s/%s/FivetoForty_RunNumber_%d_Sys_%s_Vtx_%s_%s_TP2D_Pre_QNEGx.root", RPD_or_HF.c_str(), RunNumber, Systematics.c_str(), Vertex.c_str(), RunNumber, Systematics.c_str(), Vertex.c_str(), RPD_or_HF.c_str()));
	TP2D_Pre_QNEGy->Draw("text");
	D->SaveAs(Form("/data2/users/ebadams/Eric_SP_Data_Sets/%s/%d/PNG/%s/%s/FivetoForty_RunNumber_%d_Sys_%s_Vtx_%s_%s_TP2D_Pre_QNEGy.png", RPD_or_HF.c_str(), RunNumber, Systematics.c_str(), Vertex.c_str(), RunNumber, Systematics.c_str(), Vertex.c_str(), RPD_or_HF.c_str()));
	TP2D_Pre_QNEGy->SaveAs(Form("/data2/users/ebadams/Eric_SP_Data_Sets/%s/%d/ROOT/%s/%s/FivetoForty_RunNumber_%d_Sys_%s_Vtx_%s_%s_TP2D_Pre_QNEGy.root", RPD_or_HF.c_str(), RunNumber, Systematics.c_str(), Vertex.c_str(), RunNumber, Systematics.c_str(), Vertex.c_str(), RPD_or_HF.c_str()));
	TP2D_Pre_QPOSx->Draw("text");
	D->SaveAs(Form("/data2/users/ebadams/Eric_SP_Data_Sets/%s/%d/PNG/%s/%s/FivetoForty_RunNumber_%d_Sys_%s_Vtx_%s_%s_TP2D_Pre_QPOSx.png", RPD_or_HF.c_str(), RunNumber, Systematics.c_str(), Vertex.c_str(), RunNumber, Systematics.c_str(), Vertex.c_str(), RPD_or_HF.c_str()));
	TP2D_Pre_QPOSx->SaveAs(Form("/data2/users/ebadams/Eric_SP_Data_Sets/%s/%d/ROOT/%s/%s/FivetoForty_RunNumber_%d_Sys_%s_Vtx_%s_%s_TP2D_Pre_QPOSx.root", RPD_or_HF.c_str(), RunNumber, Systematics.c_str(), Vertex.c_str(), RunNumber, Systematics.c_str(), Vertex.c_str(), RPD_or_HF.c_str()));
	TP2D_Pre_QPOSy->Draw("text");
	D->SaveAs(Form("/data2/users/ebadams/Eric_SP_Data_Sets/%s/%d/PNG/%s/%s/FivetoForty_RunNumber_%d_Sys_%s_Vtx_%s_%s_TP2D_Pre_QPOSy.png", RPD_or_HF.c_str(), RunNumber , Systematics.c_str(), Vertex.c_str(), RunNumber, Systematics.c_str(), Vertex.c_str(), RPD_or_HF.c_str()));
	TP2D_Pre_QPOSy->SaveAs(Form("/data2/users/ebadams/Eric_SP_Data_Sets/%s/%d/ROOT/%s/%s/FivetoForty_RunNumber_%d_Sys_%s_Vtx_%s_%s_TP2D_Pre_QPOSy.root", RPD_or_HF.c_str(), RunNumber , Systematics.c_str(), Vertex.c_str(), RunNumber, Systematics.c_str(), Vertex.c_str(), RPD_or_HF.c_str()));
	TP2D_Post_QNEGx->Draw("text");
	D->SaveAs(Form("/data2/users/ebadams/Eric_SP_Data_Sets/%s/%d/PNG/%s/%s/FivetoForty_RunNumber_%d_Sys_%s_Vtx_%s_%s_TP2D_Post_QNEGx.png", RPD_or_HF.c_str(), RunNumber , Systematics.c_str(), Vertex.c_str(), RunNumber, Systematics.c_str(), Vertex.c_str(), RPD_or_HF.c_str()));
	TP2D_Post_QNEGx->SaveAs(Form("/data2/users/ebadams/Eric_SP_Data_Sets/%s/%d/ROOT/%s/%s/FivetoForty_RunNumber_%d_Sys_%s_Vtx_%s_%s_TP2D_Post_QNEGx.root", RPD_or_HF.c_str(), RunNumber , Systematics.c_str(), Vertex.c_str(), RunNumber, Systematics.c_str(), Vertex.c_str(), RPD_or_HF.c_str()));
	TP2D_Post_QNEGy->Draw("text");
	D->SaveAs(Form("/data2/users/ebadams/Eric_SP_Data_Sets/%s/%d/PNG/%s/%s/FivetoForty_RunNumber_%d_Sys_%s_Vtx_%s_%s_TP2D_Post_QNEGy.png", RPD_or_HF.c_str(), RunNumber , Systematics.c_str(), Vertex.c_str(), RunNumber, Systematics.c_str(), Vertex.c_str(), RPD_or_HF.c_str()));
	TP2D_Post_QNEGy->SaveAs(Form("/data2/users/ebadams/Eric_SP_Data_Sets/%s/%d/ROOT/%s/%s/FivetoForty_RunNumber_%d_Sys_%s_Vtx_%s_%s_TP2D_Post_QNEGy.root", RPD_or_HF.c_str(), RunNumber , Systematics.c_str(), Vertex.c_str(), RunNumber, Systematics.c_str(), Vertex.c_str(), RPD_or_HF.c_str()));
	TP2D_Post_QPOSx->Draw("text");
	D->SaveAs(Form("/data2/users/ebadams/Eric_SP_Data_Sets/%s/%d/PNG/%s/%s/FivetoForty_RunNumber_%d_Sys_%s_Vtx_%s_%s_TP2D_Post_QPOSx.png", RPD_or_HF.c_str(), RunNumber , Systematics.c_str(), Vertex.c_str(), RunNumber, Systematics.c_str(), Vertex.c_str(), RPD_or_HF.c_str()));
	TP2D_Post_QPOSx->SaveAs(Form("/data2/users/ebadams/Eric_SP_Data_Sets/%s/%d/ROOT/%s/%s/FivetoForty_RunNumber_%d_Sys_%s_Vtx_%s_%s_TP2D_Post_QPOSx.root", RPD_or_HF.c_str(), RunNumber , Systematics.c_str(), Vertex.c_str(), RunNumber, Systematics.c_str(), Vertex.c_str(), RPD_or_HF.c_str()));
	TP2D_Post_QPOSy->Draw("text");
	D->SaveAs(Form("/data2/users/ebadams/Eric_SP_Data_Sets/%s/%d/PNG/%s/%s/FivetoForty_RunNumber_%d_Sys_%s_Vtx_%s_%s_TP2D_Post_QPOSy.png", RPD_or_HF.c_str(), RunNumber , Systematics.c_str(), Vertex.c_str(), RunNumber, Systematics.c_str(), Vertex.c_str(), RPD_or_HF.c_str()));
	TP2D_Post_QPOSy->SaveAs(Form("/data2/users/ebadams/Eric_SP_Data_Sets/%s/%d/ROOT/%s/%s/FivetoForty_RunNumber_%d_Sys_%s_Vtx_%s_%s_TP2D_Post_QPOSy.root", RPD_or_HF.c_str(), RunNumber , Systematics.c_str(), Vertex.c_str(), RunNumber, Systematics.c_str(), Vertex.c_str(), RPD_or_HF.c_str()));
	V1_Eta_Pre_Denominator->Draw("text");
	D->SaveAs(Form("/data2/users/ebadams/Eric_SP_Data_Sets/%s/%d/PNG/%s/%s/FivetoForty_RunNumber_%d_Sys_%s_Vtx_%s_%s_V1_Eta_Pre_Denominator.png", RPD_or_HF.c_str(), RunNumber, Systematics.c_str(), Vertex.c_str(), RunNumber, Systematics.c_str(), Vertex.c_str(), RPD_or_HF.c_str()));
	V1_Eta_Pre_Denominator->SaveAs(Form("/data2/users/ebadams/Eric_SP_Data_Sets/%s/%d/ROOT/%s/%s/FivetoForty_RunNumber_%d_Sys_%s_Vtx_%s_%s_V1_Eta_Pre_Denominator.root", RPD_or_HF.c_str(), RunNumber , Systematics.c_str(), Vertex.c_str(), RunNumber, Systematics.c_str(), Vertex.c_str(), RPD_or_HF.c_str()));
	V1_Neg_Eta_Pre_Numerator->Draw("text");
	D->SaveAs(Form("/data2/users/ebadams/Eric_SP_Data_Sets/%s/%d/PNG/%s/%s/FivetoForty_RunNumber_%d_Sys_%s_Vtx_%s_%s_V1_Neg_Eta_Pre_Numerator.png", RPD_or_HF.c_str(), RunNumber , Systematics.c_str(), Vertex.c_str(), RunNumber, Systematics.c_str(), Vertex.c_str(), RPD_or_HF.c_str()));
	V1_Neg_Eta_Pre_Numerator->SaveAs(Form("/data2/users/ebadams/Eric_SP_Data_Sets/%s/%d/ROOT/%s/%s/FivetoForty_RunNumber_%d_Sys_%s_Vtx_%s_%s_V1_Neg_Eta_Pre_Numerator.root", RPD_or_HF.c_str(), RunNumber , Systematics.c_str(), Vertex.c_str(), RunNumber, Systematics.c_str(), Vertex.c_str(), RPD_or_HF.c_str()));
	V1_Pos_Eta_Pre_Numerator->Draw("text");
	D->SaveAs(Form("/data2/users/ebadams/Eric_SP_Data_Sets/%s/%d/PNG/%s/%s/FivetoForty_RunNumber_%d_Sys_%s_Vtx_%s_%s_V1_Pos_Eta_Pre_Numerator.png", RPD_or_HF.c_str(), RunNumber , Systematics.c_str(), Vertex.c_str(), RunNumber, Systematics.c_str(), Vertex.c_str(), RPD_or_HF.c_str()));
	V1_Pos_Eta_Pre_Numerator->SaveAs(Form("/data2/users/ebadams/Eric_SP_Data_Sets/%s/%d/ROOT/%s/%s/FivetoForty_RunNumber_%d_Sys_%s_Vtx_%s_%s_V1_Pos_Eta_Pre_Numerator.root", RPD_or_HF.c_str(), RunNumber , Systematics.c_str(), Vertex.c_str(), RunNumber, Systematics.c_str(), Vertex.c_str(), RPD_or_HF.c_str()));
	V1_Pt_Pre_Denominator->Draw("text");
	D->SaveAs(Form("/data2/users/ebadams/Eric_SP_Data_Sets/%s/%d/PNG/%s/%s/FivetoForty_RunNumber_%d_Sys_%s_Vtx_%s_%s_V1_Pt_Pre_Denominator.png", RPD_or_HF.c_str(), RunNumber , Systematics.c_str(), Vertex.c_str(), RunNumber, Systematics.c_str(), Vertex.c_str(), RPD_or_HF.c_str()));
	V1_Pt_Pre_Denominator->SaveAs(Form("/data2/users/ebadams/Eric_SP_Data_Sets/%s/%d/ROOT/%s/%s/FivetoForty_RunNumber_%d_Sys_%s_Vtx_%s_%s_V1_Pt_Pre_Denominator.root", RPD_or_HF.c_str(), RunNumber , Systematics.c_str(), Vertex.c_str(), RunNumber, Systematics.c_str(), Vertex.c_str(), RPD_or_HF.c_str()));
	V1_Neg_Pt_Pre_Numerator->Draw("text");
	D->SaveAs(Form("/data2/users/ebadams/Eric_SP_Data_Sets/%s/%d/PNG/%s/%s/FivetoForty_RunNumber_%d_Sys_%s_Vtx_%s_%s_V1_Neg_Pt_Pre_Numerator.png", RPD_or_HF.c_str(), RunNumber , Systematics.c_str(), Vertex.c_str(), RunNumber, Systematics.c_str(), Vertex.c_str(), RPD_or_HF.c_str()));
	V1_Neg_Pt_Pre_Numerator->SaveAs(Form("/data2/users/ebadams/Eric_SP_Data_Sets/%s/%d/ROOT/%s/%s/FivetoForty_RunNumber_%d_Sys_%s_Vtx_%s_%s_V1_Neg_Pt_Pre_Numerator.root", RPD_or_HF.c_str(), RunNumber , Systematics.c_str(), Vertex.c_str(), RunNumber, Systematics.c_str(), Vertex.c_str(), RPD_or_HF.c_str()));
	V1_Pos_Pt_Pre_Numerator->Draw("text");
	D->SaveAs(Form("/data2/users/ebadams/Eric_SP_Data_Sets/%s/%d/PNG/%s/%s/FivetoForty_RunNumber_%d_Sys_%s_Vtx_%s_%s_V1_Pos_Pt_Pre_Numerator.png", RPD_or_HF.c_str(), RunNumber , Systematics.c_str(), Vertex.c_str(), RunNumber, Systematics.c_str(), Vertex.c_str(), RPD_or_HF.c_str()));
	V1_Pos_Pt_Pre_Numerator->SaveAs(Form("/data2/users/ebadams/Eric_SP_Data_Sets/%s/%d/ROOT/%s/%s/FivetoForty_RunNumber_%d_Sys_%s_Vtx_%s_%s_V1_Pos_Pt_Pre_Numerator.root", RPD_or_HF.c_str(), RunNumber , Systematics.c_str(), Vertex.c_str(), RunNumber, Systematics.c_str(), Vertex.c_str(), RPD_or_HF.c_str()));
	...
	for (int d = 0; d < 10; d++){
		...
		D->SaveAs(Form("/data2/users/ebadams/Eric_SP_Data_Sets/%s/%d/PNG/%s/%s/RunNumber_%d_Sys_%s_Vtx_%s_%s_V1_Even_Histo_5-40_%s.png", RPD_or_HF.c_str(), RunNumber,  Systematics.c_str(), Vertex.c_str(),RunNumber, Systematics.c_str(), Vertex.c_str(), RPD_or_HF.c_str(), centralitystring[d].c_str()));
		V1_Even_Histo[d]->SaveAs(Form("/data2/users/ebadams/Eric_SP_Data_Sets/%s/%d/ROOT/%s/%s/RunNumber_%d_Sys_%s_Vtx_%s_%s_V1_Even_Histo_5-40_%s.root", RPD_or_HF.c_str(), RunNumber,  Systematics.c_str(), Vertex.c_str(),RunNumber, Systematics.c_str(), Vertex.c_str(), RPD_or_HF.c_str(), centralitystring[d].c_str()));
		V1_Odd_Histo[d]->Draw("HIST E0"); 
		V1_Odd_Histo[d]->SetMarkerStyle(20);
		V1_Odd_Histo[d]->SetMarkerSize(3);
		D->SaveAs(Form("/data2/users/ebadams/Eric_SP_Data_Sets/%s/%d/PNG/%s/%s/RunNumber_%d_Sys_%s_Vtx_%s_%s_V1_Odd_Histo_5-40_%s.png", RPD_or_HF.c_str(), RunNumber,  Systematics.c_str(), Vertex.c_str(),RunNumber, Systematics.c_str(), Vertex.c_str(), RPD_or_HF.c_str(), centralitystring[d].c_str()));
		V1_Odd_Histo[d]->SaveAs(Form("/data2/users/ebadams/Eric_SP_Data_Sets/%s/%d/ROOT/%s/%s/RunNumber_%d_Sys_%s_Vtx_%s_%s_V1_Odd_Histo_5-40_%s.root", RPD_or_HF.c_str(), RunNumber,  Systematics.c_str(), Vertex.c_str(),RunNumber, Systematics.c_str(), Vertex.c_str(), RPD_or_HF.c_str(), centralitystring[d].c_str()));
	}
