...
//2D
auto TP_Even_X = new TProfile2D("PRE_X_FlowVectorsEvenWholeTracker","Even_X_FlowVectorInformationWholeTracker_w_CENT; Centrality Bins (10); Top ROW Errors (STDDEV), Bottom Row Means",10,0,10,2,0,2,"s(j)");//new TProfile("Even_X_v_Y","Profile of EVEN X versus Y vectors; X vector; Y vector",1,-2,2,-2,2);
auto TP_Odd_X  = new TProfile2D("PRE_X_FlowVectorsOddWholeTracker","Odd_X_FlowVectorInformationWholeTracker_w_CENT; Centrality Bins (10); Top ROW Errors (STDDEV), Bottom Row Means",10,0,10,2,0,2,"s(j)");//new TProfile("Odd_X_v_Y ","Profile of ODD X versus Y vectors; X vector; Y vector" ,1,-2,2,-2,2);
auto TP_Even_Y = new TProfile2D("PRE_Y_FlowVectorsEvenWholeTracker","Even_Y_FlowVectorInformationWholeTracker_w_CENT; Centrality Bins (10); Top ROW Errors (STDDEV), Bottom Row Means",10,0,10,2,0,2,"s(j)");//new TProfile("Even_X_v_Y","Profile of EVEN X versus Y vectors; X vector; Y vector",1,-2,2,-2,2);
auto TP_Odd_Y  = new TProfile2D("PRE_Y_FlowVectorsOddWholeTracker","Odd_Y_FlowVectorInformationWholeTracker_w_CENT; Centrality Bins (10); Top ROW Errors (STDDEV), Bottom Row Means",10,0,10,2,0,2,"s(j)");//new TProfile("Odd_X_v_Y ","Profile of ODD X versus Y vectors; X vector; Y vector" ,1,-2,2,-2,2);
...
Int_t PlotterForEric(int runnumber, int numSystematics){
  string Systematics;
  if (numSystematics == 0){
    Systematics = "Normal";
  }
...
void PrettyPlots(int runnumber, string Systematics){
 ...
 // new TCanvas;
  ...
  D->SaveAs(Form("/data2/users/ebadams/Eric_HF_RXN_Data_Sets/%d/Raw_EP_odd_%d.png", runnumber, runnumber));
  hEP_odd->SaveAs(Form("/data2/users/ebadams/Eric_HF_RXN_Data_Sets/%d/Raw_EP_odd_%d.root", runnumber, runnumber));
  ...
  D->SaveAs(Form("Raw_EP_even_%d_%d.png", runnumber, runnumber));
  hEP_even->SaveAs(Form("/data2/users/ebadams/Eric_HF_RXN_Data_Sets/%d/Raw_EP_even_%d.root", runnumber, runnumber));

  numEvents->Draw();
  D->SaveAs(Form("/data2/users/ebadams/Eric_HF_RXN_Data_Sets/%d/Raw_NumberOfEvents_%d.png", runnumber, runnumber));
  ...
  TP_Even_X->Draw("text");
  D->SaveAs(Form("/data2/users/ebadams/Eric_HF_RXN_Data_Sets/%d/Even/%s/%d_PRE_CENTERING_TP_Even_X.png" , runnumber, Systematics.c_str(), runnumber));
  TP_Even_X->SaveAs(Form("/data2/users/ebadams/Eric_HF_RXN_Data_Sets/%d/Even/%s/%d_PRE_CENTERING_TP_Even_X.root", runnumber, Systematics.c_str(), runnumber));
  ...
  TP_Odd_X->Draw("text");
  D->SaveAs(Form("/data2/users/ebadams/Eric_HF_RXN_Data_Sets/%d/Odd/%s/%d_PRE_CENTERING_TP_Odd_X.png" , runnumber, Systematics.c_str(), runnumber));
  TP_Odd_X->SaveAs(Form("/data2/users/ebadams/Eric_HF_RXN_Data_Sets/%d/Odd/%s/%d_PRE_CENTERING_TP_Odd_X.root", runnumber, Systematics.c_str(), runnumber));
  ...
  TP_Even_Y->Draw("text");
  D->SaveAs(Form("/data2/users/ebadams/Eric_HF_RXN_Data_Sets/%d/Even/%s/%d_PRE_CENTERING_TP_Even_Y.png" , runnumber, Systematics.c_str(), runnumber));
  TP_Even_Y->SaveAs(Form("/data2/users/ebadams/Eric_HF_RXN_Data_Sets/%d/Even/%s/%d_PRE_CENTERING_TP_Even_Y.root", runnumber, Systematics.c_str(), runnumber));
  ...
  TP_Odd_Y->Draw("text");
  D->SaveAs(Form("/data2/users/ebadams/Eric_HF_RXN_Data_Sets/%d/Odd/%s/%d_PRE_CENTERING_TP_Odd_Y.png" , runnumber, Systematics.c_str(), runnumber));
  TP_Odd_Y->SaveAs(Form("/data2/users/ebadams/Eric_HF_RXN_Data_Sets/%d/Odd/%s/%d_PRE_CENTERING_TP_Odd_Y.root", runnumber, Systematics.c_str(), runnumber)); //in essence the fruit of this software is these root files as the values are accessed by a seperate program which uses the histogram to read the values. pretty cleer if i do say so myself.
  ...
  D->SaveAs(Form("/data2/users/ebadams/Eric_HF_RXN_Data_Sets/%d/Even/%s/Cent_0-10/PRE_OneDTP_Even_X_Y_0_10.png", runnumber, Systematics.c_str()));
  ...
  for (int i = 1; i < 3; i++){
   ...
   D->SaveAs(Form("/data2/users/ebadams/Eric_HF_RXN_Data_Sets/%d/Odd/%s/Cent_0-10/PRE_OneDTP_Odd_X_Y_0_10.png", runnumber, Systematics.c_str()));
 ...
 D->SaveAs(Form("/data2/users/ebadams/Eric_HF_RXN_Data_Sets/%d/Even/%s/Cent_10-20/PRE_OneDTP_Even_X_Y_10_20.png", runnumber, Systematics.c_str()));
  ...
  D->SaveAs(Form("/data2/users/ebadams/Eric_HF_RXN_Data_Sets/%d/Odd/%s/Cent_10-20/PRE_OneDTP_Odd_X_Y_10_20.png", runnumber, Systematics.c_str()));
 ...
 D->SaveAs(Form("/data2/users/ebadams/Eric_HF_RXN_Data_Sets/%d/Even/%s/Cent_20-30/PRE_OneDTP_Even_X_Y_20_30.png", runnumber, Systematics.c_str()));
  ...
  D->SaveAs(Form("/data2/users/ebadams/Eric_HF_RXN_Data_Sets/%d/Odd/%s/Cent_20-30/PRE_OneDTP_Odd_X_Y_20_30.png", runnumber, Systematics.c_str()));
 ...
 D->SaveAs(Form("/data2/users/ebadams/Eric_HF_RXN_Data_Sets/%d/Even/%s/Cent_30-40/PRE_OneDTP_Even_X_Y_30_40.png", runnumber, Systematics.c_str()));
  ...
  D->SaveAs(Form("/data2/users/ebadams/Eric_HF_RXN_Data_Sets/%d/Odd/%s/Cent_30-40/PRE_OneDTP_Odd_X_Y_30_40.png", runnumber, Systematics.c_str()));
 ...
 D->SaveAs(Form("/data2/users/ebadams/Eric_HF_RXN_Data_Sets/%d/Even/%s/Cent_40-50/PRE_OneDTP_Even_X_Y_40_50.png", runnumber, Systematics.c_str()));
  ...
  D->SaveAs(Form("/data2/users/ebadams/Eric_HF_RXN_Data_Sets/%d/Odd/%s/Cent_40-50/PRE_OneDTP_Odd_X_Y_40_50.png", runnumber, Systematics.c_str()));
 ...
 D->SaveAs(Form("/data2/users/ebadams/Eric_HF_RXN_Data_Sets/%d/Even/%s/Cent_50-60/PRE_OneDTP_Even_X_Y_50_60.png", runnumber, Systematics.c_str()));
  ...
  D->SaveAs(Form("/data2/users/ebadams/Eric_HF_RXN_Data_Sets/%d/Odd/%s/Cent_50-60/PRE_OneDTP_Odd_X_Y_50_60.png", runnumber, Systematics.c_str()));
 ...
 D->SaveAs(Form("/data2/users/ebadams/Eric_HF_RXN_Data_Sets/%d/Even/%s/Cent_60-70/PRE_OneDTP_Even_X_Y_60_70.png", runnumber, Systematics.c_str()));
  ...
  D->SaveAs(Form("/data2/users/ebadams/Eric_HF_RXN_Data_Sets/%d/Odd/%s/Cent_60-70/PRE_OneDTP_Odd_X_Y_60_70.png", runnumber, Systematics.c_str()));
 ...
 D->SaveAs(Form("/data2/users/ebadams/Eric_HF_RXN_Data_Sets/%d/Even/%s/Cent_70-80/PRE_OneDTP_Even_X_Y_70_80.png", runnumber, Systematics.c_str()));
  ...
  D->SaveAs(Form("/data2/users/ebadams/Eric_HF_RXN_Data_Sets/%d/Odd/%s/Cent_70-80/PRE_OneDTP_Odd_X_Y_70_80.png", runnumber, Systematics.c_str()));
 ...
 D->SaveAs(Form("/data2/users/ebadams/Eric_HF_RXN_Data_Sets/%d/Even/%s/Cent_80-90/PRE_OneDTP_Even_X_Y_80_90.png", runnumber, Systematics.c_str()));
  ...
  D->SaveAs(Form("/data2/users/ebadams/Eric_HF_RXN_Data_Sets/%d/Odd/%s/Cent_80-90/PRE_OneDTP_Odd_X_Y_80_90.png", runnumber, Systematics.c_str()));
...
D->SaveAs(Form("/data2/users/ebadams/Eric_HF_RXN_Data_Sets/%d/Even/%s/Cent_90-100/PRE_OneDTP_Even_X_Y_90_10.png", runnumber, Systematics.c_str()));
 ...
 D->SaveAs(Form("/data2/users/ebadams/Eric_HF_RXN_Data_Sets/%d/Odd/%s/Cent_90-100/PRE_OneDTP_Odd_X_Y_90_10.png", runnumber, Systematics.c_str()));

  /*ofstream myfile;
  myfile.open ("/home/ebadams/JAIME_GUIDED_CODE/HF_Even_Odd/MeansandSTDDEV.txt");
*/
...
*/
   ...
   Y_Even_legend[i]->SetHeader(Form("Legend %s",centralitystring[i].c_str()),"C");
    ...
    /*TP_Even_Y->Draw("colz");*/
    /*D->SaveAs("TP_Even_Y.png",runnumber);*/
    /* TP_Odd_Y->Draw("colz");*/
    /* D->SaveAs(" TP_Odd_Y.png",runnumber);*/
    ...
    D->SaveAs(Form("/data2/users/ebadams/Eric_HF_RXN_Data_Sets/%d/Even/%s/PRE_FlowVector_X_Even_%s.png",runnumber, Systematics.c_str(),centralitystring[i].c_str()));
    D->Clear();
    D->Divide(2);
    D->cd(1);
    ...
    D->cd();
    X_Odd_legend[i]->Draw();
    D->SaveAs(Form("/data2/users/ebadams/Eric_HF_RXN_Data_Sets/%d/Odd/%s/PRE_FlowVector_X_Odd_%s.png",runnumber, Systematics.c_str(),centralitystring[i].c_str()));
    D->Clear();
    D->Divide(2);
    D->cd(1);
    ...
    D->SaveAs(Form("/data2/users/ebadams/Eric_HF_RXN_Data_Sets/%d/Even/%s/PRE_FlowVector_Y_Even_%s.png",runnumber, Systematics.c_str(),centralitystring[i].c_str()));
    D->Clear();
    D->Divide(2);
    D->cd(1);
    ...
    D->cd();
    Y_Odd_legend[i]->Draw();
    D->SaveAs(Form("/data2/users/ebadams/Eric_HF_RXN_Data_Sets/%d/Odd/%s/PRE_FlowVector_Y_Odd_%s.png",runnumber, Systematics.c_str(),centralitystring[i].c_str()));
  }
